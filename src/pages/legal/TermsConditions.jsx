...
const TermsConditions = () => {
  return (
    <>
      <Helmet>
        <title>{"Terms and Conditions | Kundali Expert"}</title>
        <meta
          name="description"
          content={"Terms and Conditions | Kundali Expert"}
        />
      </Helmet>
            ...
            <div className="privacy-policy-container pt-5 pb-2">
              ...
              <section>
                <div className="rdsPonit">
                  <h6 class="pb-3">Terms & Conditions Updated on 2023-01-01</h6>
                  <h6 class="pt-4">General Terms</h6>
                  <p>
                    By accessing and placing an order with KUNDALI EXPERT, you
                    ...
                    KUNDALI EXPERT. Under no circumstances shall KUNDALI EXPERT
                    team be liable for any direct, indirect, special,
                    incidental, or consequential damages, including, but not
                    limited to, loss of data or profit, arising out of the use,
                    or the inability to use, the materials on this site, even if
                    KUNDALI EXPERT team or an authorized representative has been
                    ...
                    costs thereof. KUNDALI EXPERT will not be responsible for
                    any outcome that may occur during the course of usage of our
                    resources. We reserve the right to change prices and revise
                    the resource usage policy at any time.
                  </p>
                  <h6 class="pt-5">General Terms</h6>
                  <p>
                    KUNDALI EXPERT grants you a revocable, non-exclusive,
                    non-transferable, limited license to download, install and
                    use the website/app strictly in accordance with the terms of
                    this Agreement. These Terms & Conditions are a contract
                    between you and KUNDALI EXPERT (referred to in these Terms &
                    Conditions as "KUNDALI EXPERT", "us", "we" or "our"), the
                    provider of the KUNDALI EXPERT website and the services
                    accessible from the KUNDALI EXPERT website (which are
                    collectively referred to in these Terms & Conditions as the
                    "KUNDALI EXPERT Service"). You are agreeing to be bound by
                    these Terms & Conditions. If you do not agree to these Terms
                    & Conditions, please do not use the KUNDALI EXPERT Service.
                  ...
                  <h6 class="pt-5">Definitions and Key Terms</h6>
                  <p>
                    To help explain things as clearly as possible in these Terms
                    & Conditions, every time any of these terms are referenced,
                    they are strictly defined as:
                  </p>
                  <p>
                    <b>Cookie:</b> small amount of data generated by a website
                  ...
                  <p>
                    ...
                    “us,” or “our,” it refers to K M ASTROGURU PVT.LTD, A 364,
                    Block B, Sector 23, Sanjay Nagar, Ghaziabad, Uttar Pradesh
                    201002 that is responsible for your information under these
                    Terms & Conditions.
                  </p>
                  <p>
                    <b>Country:</b> where KUNDALI EXPERT or the owners/founders
                    of KUNDALI EXPERT are based, in this case, India.
                  </p>
                  <p>
                    <b>Device:</b> any internet-connected device such as a
                    phone, tablet, computer, or any other device that can be
                    used to visit KUNDALI EXPERT and use the services.
                  </p>
                  <p>
                    <b>Service:</b> refers to the service provided by KUNDALI
                    EXPERT as described in the relative terms (if available) and
                    on this platform.
                  </p>
                  <p>
                  ...
                  <p>
                    <b>Website:</b> KUNDALI EXPERT's site, which can be accessed
                    via this URL:{" "}
                    <a href="https://www.kundaliexpert.com/">
                      www.kundaliexpert.com
                    </a>
                    .
                  </p>
                  <h6 class="pt-5">Restrictions</h6>
                  ...
                  <p>
                    ...
                    any notice of copyright or trademark) of KUNDALI EXPERT or
              ...
              <section>
                ...
                <div className="rdsPonit">
                  ...
                  <p>
                    1. License, sell, rent, lease, assign, distribute, transmit,
                    host, outsource, disclose or otherwise commercially exploit
                    the website/app or make the platform available to any third
                    party.
                  </p>
                  <p>
                    2. Modify, make derivative works of, disassemble, decrypt,
                    reverse compile or reverse engineer any part of the
                    website/app.
                  </p>
                  <p>
                    3. Remove, alter or obscure any proprietary notice
                    (including any notice of copyright or trademark) of KUNDALI
                    EXPERT or its affiliates, partners, suppliers or the
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    Thanks for shopping at KUNDALI EXPERT. We appreciate the
                    ...
                    apply to transactions at KUNDALI EXPERT. We’ll be as brief
                    as our attorneys will allow. The main thing to remember is
                    that by placing an order or making a purchase at KUNDALI
                    EXPERT, you agree to the terms along with KUNDALI
                    EXPERT."’s" Privacy Policy. If, for any reason, You are not
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    (collectively, "Suggestions") provided by you to KUNDALI
                    EXPERT with respect to the website/app shall remain the sole
                    and exclusive property of KUNDALI EXPERT. KUNDALI EXPERT
                    shall be free to use, copy, modify, publish, or redistribute
                    the Suggestions for any purpose and in any way without any
                    credit or any compensation to you. Your Consent We've
                    updated our Terms & Conditions to provide you with complete
                    transparency into what is being set when you visit our site
                    and how it's being used. By using our website/app,
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    controlled by KUNDALI EXPERT. We are not responsible for the
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    KUNDALI EXPERT uses "Cookies" to identify the areas of our
                    ...
                    Identifiable Information in Cookies. Changes To Our Terms &
                    Conditions You acknowledge and agree that may stop
                    (permanently or temporarily) providing the Service (or any
                    features within the Service) to you or to users generally at
                    ’s sole discretion, without prior notice to you. You may
                    stop using the Service at any time. You do not need to
                    specifically inform when you stop using the Service. You
                    acknowledge and agree that if disables access to your
                    account, you may be prevented from accessing the Service,
                    your account details or any files or other materials which
                    is contained in your account. If we decide to change our
                    Terms & Conditions, we will post those changes on this page,
                    and/or update the Terms & Conditions modification date
                    below.
                  </p>
                </div>
              </section>
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    KUNDALI EXPERT reserves the right to modify, suspend or
                    discontinue, temporarily or permanently, the website/app or
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    KUNDALI EXPERT may from time to time provide enhancements or
                    ...
                    the website/app. You agree that KUNDALI EXPERT has no
                    obligation to (i) provide any Updates, or (ii) continue to
                    provide or enable any particular features and/or
                    functionalities of the website/app to you. You further agree
                    that all Updates will be (i) deemed to constitute an
                    integral part of the website/app, and (ii) subject to the
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    agree that KUNDALI EXPERT shall not be responsible for any
                    ...
                    KUNDALI EXPERT does not assume and shall not have any
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    you or KUNDALI EXPERT. KUNDALI EXPERT may, in its sole
                    ...
                    from KUNDALI EXPERT, in the event that you fail to comply
                    with any provision of this Agreement. You may also terminate
                    this Agreement by deleting the website/app and all copies
                    thereof from your computer. Upon termination of this
                    Agreement, you shall cease all use of the website/app and
                    delete all copies of the website/app from your computer.
                    Termination of this Agreement will not limit any of KUNDALI
                    EXPERT's rights or remedies at law or in equity in case of
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    You agree to indemnify and hold KUNDALI EXPERT and its
                    ...
                    to or arising out of your: (a) use of the website/app; (b)
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    applicable law, KUNDALI EXPERT, on its own behalf and on
                    ...
                    to the foregoing, KUNDALI EXPERT provides no warranty or
                    undertaking, and makes no representation of any kind that
                    the website/app will meet your requirements, achieve any
                    intended results, be compatible or work with any other
                    software, , systems or services, operate without
                    interruption, meet any performance or reliability standards
                    or be error free or that any errors or defects can or will
                    be corrected. Without limiting the foregoing, neither
                    KUNDALI EXPERT nor any KUNDALI EXPERT's provider makes any
                    representation or warranty of any kind, express or implied:
                    (i) as to the operation or availability of the website/app,
                    or the information, content, and materials or products
                    included thereon; (ii) that the website/app will be
                    uninterrupted or error-free; (iii) as to the accuracy,
                    reliability, or currency of any information or content
                    provided through the website/app; or (iv) that the
                    website/app, its servers, the content, or e-mails sent from
                    or on behalf of KUNDALI EXPERT are free of viruses, scripts,
                    trojan horses, worms, malware, timebombs or other harmful
                    components. Some jurisdictions do not allow the exclusion of
                    or limitations on implied warranties or the limitations on
                    the applicable statutory rights of a consumer, so some or
                    all of the above exclusions and limitations may not apply to
                    you.
                  </p>
                </div>
              </section>
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    liability of KUNDALI EXPERT and any of its suppliers under
                    any provision of this Agreement and your exclusive remedy
                    for all of the foregoing shall be limited to the amount
                    actually paid by you for the website/app. To the maximum
                    extent permitted by applicable law, in no event shall
                    KUNDALI EXPERT or its suppliers be liable for any special,
                    incidental, indirect, or consequential damages whatsoever
                    (including, but not limited to, damages for loss of profits,
                    for loss of data or other information, for business
                    interruption, for personal injury, for loss of privacy
                    arising out of or in any way related to the use of or
                    inability to use the website/app, third-party software
                    and/or third-party hardware used with the website/app, or
                    otherwise in connection with any provision of this
                    Agreement), even if KUNDALI EXPERT or any supplier has been
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    other legal notices published by KUNDALI EXPERT on the
                    Services, shall constitute the entire agreement between you
                    and KUNDALI EXPERT concerning the Services. If any provision
                    ...
                    and KUNDALI EXPERT."’s" failure to assert any right or
                    provision under this Agreement shall not constitute a waiver
                    of such right or provision. YOU AND KUNDALI EXPERT AGREE
                    THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE
                    SERVICES MUST COMMENCE WITHIN ONE (1) YEAR AFTER THE CAUSE
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    waiver of any subsequent breach. o failure to exercise, and
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    KUNDALI EXPERT reserves the right, at its sole discretion,
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    and KUNDALI EXPERT regarding your use of the website/app and
                    supersedes all prior and contemporaneous written or oral
                    agreements between you and KUNDALI EXPERT. You may be
                    subject to additional terms and conditions that apply when
                    you use or purchase other KUNDALI EXPERT's services, which
                    KUNDALI EXPERT will provide to you at the time of such use
                    or purchase. Updates to Our Terms We may change our Service
                    and policies, and we may need to make changes to these Terms
                    so that they accurately reflect our Service and policies.
                    Unless otherwise required by law, we will notify you (for
                    ...
                    Service, you will be bound by the updated Terms. If you do
                    not want to agree to these or any updated Terms, you can
                    delete your account.
                  </p>
                </div>
              </section>
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    KUNDALI EXPERT, its licensors or other providers of such
                    material and are protected by INDIA and international
                    ...
                    express prior written permission of KUNDALI EXPERT, unless
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    YOUR OR KUNDALI EXPERT."’s" INTELLECTUAL PROPERTY RIGHTS.
                    The term “dispute” means any dispute, action, or other
                    controversy between you and KUNDALI EXPERT concerning the
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    In the event of a dispute, you or KUNDALI EXPERT must give
                    the other a Notice of Dispute, which is a written statement
                    that sets forth the name, address, and contact information
                    of the party giving it, the facts giving rise to the
                    dispute, and the relief requested. You must send any Notice
                    of Dispute via email to: INFO@KUNDALIEXPERT.COM. KUNDALI
                    EXPERT will send any Notice of Dispute to you by mail to
                    your address if we have it, or otherwise to your email
                    address. You and KUNDALI EXPERT will attempt to resolve any
                    dispute through informal negotiation within sixty (60) days
                    from the date the Notice of Dispute is sent. After sixty
                    (60) days, you or KUNDALI EXPERT may commence arbitration.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    If you and KUNDALI EXPERT don’t resolve any dispute by
                    informal negotiation, any other effort to resolve the
                    dispute will be conducted exclusively by binding arbitration
                    as described in this section. You are giving up the right to
                    ...
                    property pending the completion of arbitration. Any and all
                    legal, accounting, and other costs, fees, and expenses
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    non-proprietary and will become the sole property of KUNDALI
                    EXPERT without any compensation or credit to you whatsoever.
                    KUNDALI EXPERT and its affiliates shall have no obligations
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    KUNDALI EXPERT may, from time to time, include contests,
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    ...
                    KUNDALI EXPERT. KUNDALI EXPERT will be entitled to
                    injunctive or other equitable relief (without the
                    obligations of posting any bond or surety) in the event of
                    any breach or anticipatory breach by you. KUNDALI EXPERT
                    operates and controls the KUNDALI EXPERT Service from its
                    offices in INDIA. The Service is not intended for
                    ...
                    who choose to access the KUNDALI EXPERT Service from other
                    ...
                    (which include and incorporate the KUNDALI EXPERT Privacy
                    Policy) contains the entire understanding, and supersedes
                    all prior understandings, between you and KUNDALI EXPERT
              ...
              <section>
                ...
                <div className="rdsPonit">
                  <p>
                    KUNDALI EXPERT is not responsible for any content, code or
                    any other imprecision. KUNDALI EXPERT does not provide
                    warranties or guarantees. In no event shall KUNDALI EXPERT
                    be liable for any special, direct, indirect, consequential,
                    or incidental damages or any damages whatsoever, whether in
                    an action of contract, negligence or other tort, arising out
                    of or in connection with the use of the Service or the
                    contents of the Service. The Company reserves the right to
                    make additions, deletions, or modifications to the contents
                    on the Service at any time without prior notice. The KUNDALI
                    EXPERT Service and its contents are provided "as is" and "as
                    available" without any warranty or representations of any
                    kind, whether express or implied. KUNDALI EXPERT is a
                    distributor and not a publisher of the content supplied by
                    third parties; as such, KUNDALI EXPERT exercises no
                    ...
                    through or accessible via the KUNDALI EXPERT Service.
                    Without limiting the foregoing, KUNDALI EXPERT specifically
                    disclaims all warranties and representations in any content
                    transmitted on or in connection with the KUNDALI EXPERT
                    Service or on sites that may appear as links on the KUNDALI
                    EXPERT Service, or in the products provided as a part of, or
                    otherwise in connection with, the KUNDALI EXPERT Service,
                    including without limitation any warranties of
                    merchantability, fitness for a particular purpose or
                    non-infringement of third party rights. No oral advice or
                    written information given by KUNDALI EXPERT or any of its
                    ...
                    limiting the foregoing, KUNDALI EXPERT does not warrant that
                    the KUNDALI EXPERT Service will be uninterrupted,
