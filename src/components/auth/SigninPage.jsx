...
const SigninPage = () => {
  ...
  const sendOtp = async (fullPhone) => {
    ...
    try {
      ...
      const fullPhoneWithCountry = mobile; // 918601971663
      ...
      const res = await fetch(
        "https://api.kundaliexpert.com/kmAstroapp/api/v1/otp/sendOTP",
        {
          method: "POST",
          ...
          <div className="container">
            <div className="heading_sec text-center">
              ...
              <p className="gray_clr">
                Enter your phone number, and we will send you the 4-digit
                verification code.
              </p>
            </div>
