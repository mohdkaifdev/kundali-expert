// src/components/course-detail/CourseBanner.jsx
...
const CourseBanner = ({ course, onPlayVideo }) => {
  return (
    <section>
                ...
                <div className="banner_listing d-flex">
                  <ul>
                    {course.features.map((feat, i) => (
                      <li key={i}>
                        <img src={checkIcon} alt="icon" className="img-fluid" /> {feat} |
                      </li>
                    ))}
                  </ul>
                  <div className="para_sec border-0">
                    <h3>Purchase Course <span>₹{course.price}</span></h3>
                  </div>
                </div>
                <div className="banner_btn pt-lg-3">
                  <a href="#" className="site_btn yellow_bg">BUY REPORT</a>
                </div>
              </div>
            </div>
            <div className="col-lg-7">
              <div className="cd_img position-relative ps-lg-5">
                <img src={courseDetailBanner} alt="img" className="w-100 br_20" />
                <div className="play_btn">
                  <a onClick={() => onPlayVideo(course.videoUrl)}>
