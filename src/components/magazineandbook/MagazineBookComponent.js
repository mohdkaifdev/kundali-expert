...
export default function Publication() {
  ...
  const getlist = async () => {
    ...
    setCurrentPage(1);
    setpublicationdata(res.data.data.slice(0, ITEMS_PER_PAGE));
  ...
  useEffect(() => {
    ...
    setpublicationdata(allData.slice(startIndex, endIndex));
  }, [currentPage, allData]);
    ...
    <section>
      <div className=" about_banner_section banner_space cd_section ">
        <div className="container">
          ...
          <div className="astro_tabs_sec publication_tabs_sec pageag">
            ...
            <div className="tab-content" id="myTabContent">
              ...
              >
                <div className="tabs_content">
                  <div className="row" style={{ background: "transparent",padding: "0px" }}>
